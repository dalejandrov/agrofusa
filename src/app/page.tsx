    ...
    >
      ...
      >
        <Image
          ...
          width={200}  
          height={200} 
          className="w-48 h-48 sm:w-56 sm:h-56 md:w-64 md:h-64 lg:w-72 lg:h-72 drop-shadow-2xl object-contain filter brightness-110 contrast-105"
          priority
        />
      </motion.div>
      ...
      <motion.h1
        ...
        className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-green-800 mb-2 sm:mb-3 md:mb-4 px-4"
      >
        Agrofusa
      </motion.h1>
      ...
      <motion.p
        variants={itemFadeInUpVariants}
        className="text-sm sm:text-base md:text-lg text-green-700 mb-6 sm:mb-8 md:mb-10 max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg px-4"
      >
